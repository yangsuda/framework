...
<input style="border-radius:0rem;" placeholder="每页显示条数" type="text" name="pagesize" size="12" class="form-control fa-1x p-1" id="pagesize" onkeydown="if(event.keyCode==13) {var pagesize=this.value;window.location=\'' . $mpurl . 'pagesize=\'+pagesize+\'' . '\';}" />
</li>
